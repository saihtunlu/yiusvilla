              ...
              n(e, [
                {
                  ...
                  value: function() {
                    (this.x = Math.random() * this.maxX),
                      ...
                      (this.size =
                        Math.random() * (t.size.max - t.size.min) + t.size.min),
                      (this.speed = {
                        x: t.speed * (Math.random() - 0.5),
                        y: t.speed * (Math.random() - 0.5),
                      });
                  },
                },
                {
                  ...
                  value: function(e) {
                    (this.x += this.speed.x),
                      ...
                      (this.x < 0 ||
                        ...
                        this.reset(),
                      e.beginPath(),
                      e.arc(this.x, this.y, this.size, 0, 2 * Math.PI, !0),
                      (e.fillStyle = t.color),
                      e.fill(),
                      e.closePath();
                  },
    ...
    2: [
      function(t, e, i) {
        ...
        window.Particles = (function() {
          ...
          return (function() {
            function t(n, o) {
              if ((r(this, t), !n || "canvas" !== n.tagName.toLowerCase()))
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    var t = this.target.offsetWidth * this.target.offsetHeight,
                      e = Math.floor(
                        t / ((1 / this.options.density) * 1e5) / 50
                      );
                    this.particles = new Array();
                    for (var r = 0; r < e; r++)
                      this.particles.push(
                        new i(this.target.offsetWidth, this.target.offsetHeight)
                      );
                    this.start();
                  },
                },
...
//# sourceMappingURL=maps/particles.js.map
